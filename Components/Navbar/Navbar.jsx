...
const Navbar = ({darkMode,setDarkMode}) => {
  ...
  return (
    <nav className={`flex justify-between items-center p-5 ${darkMode ? 'bg-gray-900 text-white' : 'bg-slate-100 text-gray-800'}`}>
      <div className="flex items-center">
        <img
          src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Mercedes-Logo.svg/1024px-Mercedes-Logo.svg.png'
          alt="Logo"
          className="w-12 h-15 mr-2"
        />
      ...
      <div
        className={`w-6 h-6 cursor-pointer ${darkMode ? 'text-white' : 'text-gray-800'}`}
